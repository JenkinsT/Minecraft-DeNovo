...
public class BarleyCrop extends BlockFlower
{
    private Icon[] iconArray;

    protected BarleyCrop(int par1)
    {
        super(par1);
    ...
    {
        return Main.barleyseeds.itemID;
    }

    protected int getCropItem()
    {
        return Main.Barley.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[var2] = par1IconRegister.registerIcon("minecraftdenovo:" + "barley_" + var2);
        }
    }
}
