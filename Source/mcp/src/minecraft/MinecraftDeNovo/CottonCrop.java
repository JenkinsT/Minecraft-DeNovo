...
public class CottonCrop extends BlockFlower
{
    private Icon[] iconArray;

    protected CottonCrop(int par1)
    {
        super(par1);
    ...
    {
        return Main.cottonseeds.itemID;
    }

    protected int getCropItem()
    {
        return Main.Cotton.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[var2] = par1IconRegister.registerIcon("MinecraftDenovo:" + "cotton_" + var2);
        }
    }
}
