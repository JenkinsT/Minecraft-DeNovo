...
public class Main
{
	...
	public static Item SpearHeadDiamond;
	public static Item PikeHeadDiamond;
	...
	public static Item WoodCuttersAxeHeadDiamond;
	public static Item WoodCuttersMatttockHeadDiamond;
    ...
    public void load(FMLInitializationEvent event)
    {
		...
		BastardSwordBladeDiamond = (new DenovoToolHead(4001)).setUnlocalizedName("bastardswordbladediamond").func_111206_d("minecraftdenovo:bastardswordbladediamond");
        ...
        HachetHeadDiamond = (new DenovoToolHead(4004)).setUnlocalizedName("hachetheaddiamond").func_111206_d("minecraftdenovo:hachetheaddiamond");
        LanguageRegistry.addName(HachetHeadDiamond, "Diamond Hachet Head");
        KukriBladeDiamond = (new DenovoToolHead(4005)).setUnlocalizedName("kukribladediamond").func_111206_d("minecraftdenovo:kukribladediamond");
        LanguageRegistry.addName(KukriBladeDiamond, "Diamond Kukri Blade");
        LongSwordBladeDiamond = (new DenovoToolHead(4006)).setUnlocalizedName("longswordbladediamond").func_111206_d("minecraftdenovo:longswordbladediamond");
        LanguageRegistry.addName(LongSwordBladeDiamond, "Diamond Longsword Blade");
        LumberAxeHeadDiamond = (new DenovoToolHead(4007)).setUnlocalizedName("lumberaxeheaddiamond").func_111206_d("minecraftdenovo:lumberaxeheaddiamond");
        LanguageRegistry.addName(LumberAxeHeadDiamond, "Diamond Lumber Axe Head");
        MaceHeadDiamond = (new DenovoToolHead(4008)).setUnlocalizedName("maceheaddiamond").func_111206_d("minecraftdenovo:maceheaddiamond");
        LanguageRegistry.addName(MaceHeadDiamond, "Diamond Mace Head");
        MinersMattockHeadDiamond = (new DenovoToolHead(4009)).setUnlocalizedName("minersmattockheaddiamond").func_111206_d("minecraftdenovo:minersmattockheaddiamond");
        LanguageRegistry.addName(MinersMattockHeadDiamond, "Diamond Miner's Mattock Head");
        SpearHeadDiamond = (new DenovoToolHead(4010)).setUnlocalizedName("spearheaddiamond").func_111206_d("minecraftdenovo:spearheaddiamond");
        LanguageRegistry.addName(SpearHeadDiamond, "Diamond Spear Point");
        PikeHeadDiamond = (new DenovoToolHead(4011)).setUnlocalizedName("pikeheaddiamond").func_111206_d("minecraftdenovo:pikeheaddiamond");
        LanguageRegistry.addName(PikeHeadDiamond, "Diamond Pike Head");
        //PlowBladeDiamond = (new DenovoToolHead(4012)).setUnlocalizedName("plowbladediamond").func_111206_d("minecraftdenovo:plowbladediamond");
        //LanguageRegistry.addName(PlowBladeDiamond, "Diamond Plow Blade");
        ScimitarBladeDiamond = (new DenovoToolHead(4013)).setUnlocalizedName("scimitarbladediamond").func_111206_d("minecraftdenovo:scimitarbladediamond");
        LanguageRegistry.addName(ScimitarBladeDiamond, "Diamond Scimitar Blade");
        //ScytheBladeDiamond = (new DenovoToolHead(4014)).setUnlocalizedName("scythebladediamond").func_111206_d("minecraftdenovo:scythebladediamond");
        //LanguageRegistry.addName(ScytheBladeDiamond, "Diamond Scythe Blade");
        ShortSwordBladeDiamond = (new DenovoToolHead(4015)).setUnlocalizedName("shortswordbladediamond").func_111206_d("minecraftdenovo:shortswordbladediamond");
        LanguageRegistry.addName(ShortSwordBladeDiamond, "Diamond Shortsword Blade");
        //ShovelHeadDiamond = (new DenovoToolHead(4016)).setUnlocalizedName("shovelheaddiamond").func_111206_d("minecraftdenovo:shovelheaddiamond");
        //LanguageRegistry.addName(ShovelHeadDiamond, "Diamond Shovel Head");
        //SwordBladeDiamond = (new DenovoToolHead(4017)).setUnlocalizedName("swordbladediamond").func_111206_d("minecraftdenovo:swordbladediamond");
        //LanguageRegistry.addName(SwordBladeDiamond, "Diamond Sword Blade");
        TomahawkHeadDiamond = (new DenovoToolHead(4018)).setUnlocalizedName("tomahawkheaddiamond").func_111206_d("minecraftdenovo:tomahawkheaddiamond");
        LanguageRegistry.addName(TomahawkHeadDiamond, "Diamond Tomahawk Head");
        WoodCuttersAxeHeadDiamond = (new DenovoToolHead(4019)).setUnlocalizedName("woodcuttersaxeheaddiamond").func_111206_d("minecraftdenovo:woodcuttersaxeheaddiamond");
        LanguageRegistry.addName(WoodCuttersAxeHeadDiamond, "Diamond WoodCutter's Axe Head");
        WoodCuttersMatttockHeadDiamond = (new DenovoToolHead(4020)).setUnlocalizedName("woodcuttersmatttockheaddiamond").func_111206_d("minecraftdenovo:woodcuttersmatttockheaddiamond");
        LanguageRegistry.addName(WoodCuttersMatttockHeadDiamond, "Diamond WoodCutter's Matttock Head");
