...
public class TurnipCrop extends BlockFlower
{
    private Icon[] iconArray;

    protected TurnipCrop(int par1)
    {
        super(par1);
    ...
    {
        return Main.turnipseeds.itemID;
    }

    protected int getCropItem()
    {
        return Main.Turnip.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[var2] = par1IconRegister.registerIcon("MinecraftDenovo:" + "turnip_" + var2);
        }
    }
}
