...
public class beetCrop extends BlockFlower
{
    private Icon[] iconArray;

    protected beetCrop(int par1)
    {
        super(par1);
    ...
    {
        return Main.beetseeds.itemID;
    }

    protected int getCropItem()
    {
        return Main.Beet.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[var2] = par1IconRegister.registerIcon("MinecraftDenovo:" + "beet_" + var2);
        }
    }
}
